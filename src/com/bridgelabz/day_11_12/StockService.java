	...
	public void buy(String companyName, int noOfShares, int balance) {
		...
		if (stockRepo.isCompanyAvailable(companyName, noOfShares)) {
			...
			if (amount <= balance) {
				...
				System.out.println("You buy " + noOfShares + "shares of" + companyName
						+ "compnay and your available balance is :" + result);
				...
				System.out.println("Sorry, You do not sufficient balance to buy the share..");
			}
		} 
		else {
